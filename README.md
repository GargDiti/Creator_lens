...
**Q: How do I log in?**
A: In demo mode, use any email and password to access the dashboard.

**Q: Where does the data come from?**
A: Currently mock data for demonstration. Production version would integrate with social media APIs.

**Q: Can I export reports?**
A: Currently reports are stored in memory. Database integration would enable persistence.

**Q: Is this production-ready?**
A: The UI/UX is production-ready. For production analytics, real data sources need to be integrated.
...
This is a demo version using mock data. For real analysis, integrate with social media APIs (e.g., Instagram Graph API, Twitter API).

For production, add database persistence and user authentication.